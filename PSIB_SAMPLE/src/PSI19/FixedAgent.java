...
public class FixedAgent extends Agent {
	...
	protected void setup() {
		...
		//System.out.println("FixedAgent " + getAID().getName() + " is ready.");
	}
	...
	private class Play extends CyclicBehaviour {
		...
		public void action() {
			...
			if (msg != null) {
				...
				System.out.println(getAID().getName() + " received " + msg.getContent() + " from " + msg.getSender().getName());
