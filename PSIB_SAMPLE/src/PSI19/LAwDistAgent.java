...
public class LAwDistAgent extends Agent {
	...
	private class Play extends CyclicBehaviour {
			...
			if(msg != null) {
				...
				case s3AwaitingResult:
					...
					if(msg.getPerformative() == ACLMessage.INFORM && msg.getContent().startsWith("Results#")) {
						int[] puntuacion = validateResultsMessage(msg.getContent());
		...
		//TODO recibir ambas puntuaciones
		private void feedbackLAAction(int[] puntuacion) {

			int distancia = puntuacion[0] - puntuacion[1];
			
			//ajustamos probabilidades
			if (distancia - ultimaDistancia > 0)	
